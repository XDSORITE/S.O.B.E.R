...
var Autocomplete = (function() {
    ...
    function create(inputId, dropdownId, opts) {
        ...
        function renderItem(feature, idx) {
            ...
            var primary = props.name || props.display_name.split(',')[0];
            var secondary = [props.street, props.city, props.state, props.country]
                .filter(Boolean).join(', ');
        ...
        function selectItem(idx) {
            ...
            close();
            if (onSelect) {
                onSelect({ lat: lat, lon: lon, label: label, properties: props });
            }
        }
        ...
        var fetchSuggestions = debounce(function(query) {
            ...
            .then(function(data) {
                ...
                items = (data || []).filter(function(f) {
                    return f && f.geometry && f.geometry.coordinates && f.properties;
                });
                render();
            })
            .catch(function() {
